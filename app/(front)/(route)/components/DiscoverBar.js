  ...
  return (
    <div>
      <ul className="items-center justify-center ">
        ...
        <li
          className="my-1 flex hover:bg-[#E7E9EB] rounded-box w-50 h-10 items-center relative"
        ...
        >
          ...
          <span className="ml-3 text-xl" onClick={() => {setShowPlayGames(!showPlayGames);}}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
        ...
        {showPlayGames && (
          <li
            className="my-1 pl-8 flex hover:bg-[#E7E9EB] rounded-box w-50 h-10 items-center">
        ...
        <li
          className="my-1 flex hover:bg-[#E7E9EB] rounded-box w-50 h-10 items-center "
        >
          <svg
            fill="#000000"
            height="25px"
      ...
      c-0.766,0-0.755-1,0-1H24v-2h-2H21z"
          ...
          <span className="ml-3 text-xl" onClick={() => {setShowNews(!showNews);}}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
