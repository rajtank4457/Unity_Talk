...
function DiscoverPage() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        let apiUrl = `${YOUTUBE_PLAYLIST_ITEMS_API}?part=snippet&channelId=${channelid}&maxResults=50&key=${apiKey}`;
  ...
  useEffect(() => {
    const channelid = "UCe31NPEeRGO0hcznx6Tdb-g";
    // gaming
    const fetchData = async () => {
      try {
        let apiUrl = `${YOUTUBE_PLAYLIST_ITEMS_API}?part=snippet&channelId=${channelid}&maxResults=50&key=${apiKey}`;
  ...
  useEffect(() => {
    const channelid = "UCYPvAwZP8pZhSMW8qs7cVCw";
    // newsapi
    const fetchData = async () => {
      try {
        let apiUrl = `${YOUTUBE_PLAYLIST_ITEMS_API}?part=snippet&channelId=${channelid}&maxResults=50&key=${apiKey}`;
  ...
  useEffect(() => {
    const channelid = "UCIdw5MR9iVtu7PHPXqJgV3A";
    // Entertainment
    const fetchData = async () => {
      try {
        let apiUrl = `${YOUTUBE_PLAYLIST_ITEMS_API}?part=snippet&channelId=${channelid}&maxResults=50&key=${apiKey}`;
  ...
  useEffect(() => {
    const channelid = "UCBwmMxybNva6P_5VmxjzwqA";
    // Education
    const fetchData = async () => {
      try {
        let apiUrl = `${YOUTUBE_PLAYLIST_ITEMS_API}?part=snippet&channelId=${channelid}&maxResults=50&key=${apiKey}`;
  ...
  return (
    <div>
      <div className="bg-[#23272A]">
        ...
        <div className="selection:text-blue-300 text-[#ebe4e4] animate__animated animate__fadeInUp">
          <p className="text-bold lg:text-5xl lg:text-center pl-4 from-accent-foreground">
            FIND YOUR COMMUNITY ON UNITY TALK
          </p>
          <p className="text-center lg:text-2xl lg:pt-2 font-serif">
            From gaming, to music, to learning, there's a place for you.
          </p>
        </div>

        <div className="pt-10 flex ">
          <div className=" animate__animated animate__bounceInLeft animate__delay-1s motion-safe:animate__duration-1s ">
            <Image
              src={discover2}
              className="h-80 w-80"
              width=""
          ...
          <div className="lg:ml-auto animate__animated animate__bounceInRight animate__delay-1s motion-safe:animate__duration-1s ">
            <Image
              src={discover3}
      ...
      <div className="lg:flex lg:pl-[292px] pt-7 bg-white text-black">
        {/* Your navigation links here */}
        <div className="md:block hidden">
          <ul className="items-center justify-center">
            <Link href="/Discover">
              <li className="my-1 flex hover:bg-[#E7E9EB] rounded-box w-50 h-10 items-center ">
                <svg
                  width="25px"
                  height="25px"
                  viewBox="0 0 24 24"
                ...
                <span className="ml-2 text-xl">All</span>
              </li>
            </Link>
            ...
            <li className="my-1 flex hover:bg-[#E7E9EB] rounded-box w-50 h-10 items-center ">
              ...
              <Link href="/Discover/News">
                <span className="ml-2 text-xl">Gaming</span>{" "}
              </Link>
            ...
            {showPlayGames && (
              <li className="my-1 pl-8 flex hover:bg-[#E7E9EB] rounded-box w-50 h-10 items-center">
                <span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <Link href="Discover/Gaming/playGame">
                  {" "}
                  <span className="ml-2 ">PlayGames</span>
                </Link>
              </li>
            )}
            ...
            <Link href="/Discover/Entertainment">
              <li className="my-1 flex hover:bg-[#E7E9EB] rounded-box w-50 h-10 items-center ">
                ...
                <span className="ml-2 text-xl">Entertainment</span>
              </li>
            </Link>
            ...
            <Link href="/Discover/Music">
              <li className="my-1 flex hover:bg-[#E7E9EB] rounded-box w-50 h-10 items-center ">
                ...
                <span className="ml-2 text-xl">Music</span>
              </li>
            </Link>
            ...
            <Link href="/Discover/Education">
              <li className="my-1 flex hover:bg-[#E7E9EB] rounded-box w-50 h-10 items-center ">
                ...
                <span className="ml-2 text-xl">Education</span>
              </li>
            </Link>
      ...
      c-0.766,0-0.755-1,0-1H24v-2h-2H21z"
            ...
            {showNews && (
              <Link href="https://news-app-tilr.onrender.com/" target="_black">
                <li className="my-1 pl-8 flex hover:bg-[#E7E9EB] rounded-box w-50 h-10 items-center">
                  <span>
                    <svg
                      fill="#000000"
                  ...
                  <span className="ml-2 ">Read News</span>
                </li>
              </Link>
            )}
          </ul>
              ...
              {data &&
                data.items.slice(startIndex, endIndex).map((item, index) => {
                  ...
                  return (
                    <li
                      key={id.videoId}
                      className="card card-side pt-7 w-[350px] lg:w-[900px] shadow-xl gap-4 lg:hover:shadow-2xl lg:hover:bg-[#E7E9EB] lg:transition-transform lg:duration-300 lg:transform lg:hover:scale-105"
                    >
                      <Link
                        href={`https://www.youtube.com/watch?v=${id.videoId}`}
                      >
